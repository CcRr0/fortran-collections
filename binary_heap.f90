MODULE binary_heap
    ...
    IMPLICIT NONE
    PUBLIC :: HEAPIFY, HEAP_PUSH, HEAP_POP, HEAP_GET, HEAP_GET_KEY, HEAP_GET_VALUE
    PRIVATE :: SIFT_UP, SIFT_DOWN, GET, GET_KEY, GET_VALUE
...
CONTAINS
    ...
    SUBROUTINE HEAP_GET(V, KEY, VALUE)
        TYPE(VEC), INTENT(INOUT) :: V
        INTEGER, INTENT(OUT) :: KEY
        CLASS(*), ALLOCATABLE, INTENT(OUT) :: VALUE

        CALL GET(V, 1, KEY, VALUE)
    ...
    SUBROUTINE GET(V, INDEX, KEY, VALUE)
        TYPE(VEC), INTENT(INOUT) :: V
        INTEGER, INTENT(IN) :: INDEX
        INTEGER, INTENT(OUT) :: KEY
        CLASS(*), ALLOCATABLE, INTENT(OUT) :: VALUE
    ...
    FUNCTION GET_VALUE(V, INDEX) RESULT(VALUE)
        TYPE(VEC), INTENT(INOUT) :: V
        INTEGER, INTENT(IN) :: INDEX
        CLASS(*), ALLOCATABLE :: VALUE
