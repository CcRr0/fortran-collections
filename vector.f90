MODULE vector
    IMPLICIT NONE
    PUBLIC :: VEC, VEC_INIT, VEC_GET, VEC_SET, VEC_PUSH_BACK, VEC_POP_BACK, VEC_SWAP, VEC_ENLARGE, VEC_DEALLOCATE
...
CONTAINS
    ...
    FUNCTION VEC_GET(V, INDEX) RESULT(VALUE)
        CLASS(VEC), INTENT(INOUT) :: V
        INTEGER, INTENT(IN) :: INDEX
        CLASS(*), ALLOCATABLE :: VALUE

        ALLOCATE (VALUE, SOURCE=V%DATA(INDEX)%VALUE)

    END FUNCTION VEC_GET
